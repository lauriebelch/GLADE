...
def main():    
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="Example usage:\n  GLADE.py -f /path/to/Orthofinder/results\n"
        "-----------------------------------------------\n"
        "-----------------------------------------------",
    ...
    print("---Thank you for choosing Orthofinder. Please cite Orthofinder3, and have a wonderful day!")
