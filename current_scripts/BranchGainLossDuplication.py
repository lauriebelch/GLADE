...
def main(ortho_folder_path):
    ...
    loss_s_file_path = os.path.join(ortho_folder_path, "GainsLossDuplication", "Loss_speciation.tsv")
    Loss_s = []
    ...
    Dupes_file_path = os.path.join(ortho_folder_path, "GainsLossDuplication", "Duplications.tsv")
    Dupes = []
    ...
    loss_pd_file_path = os.path.join(ortho_folder_path, "GainsLossDuplication", "Loss_postduplication.tsv")
    Loss_pd = []
    ...
    file_name = os.path.join(ortho_folder_path, "GainsLossDuplication/Branch_statistics.tsv")
    # Write to TSV file
    ...
    ListDictToTSV(exploded_gained, os.path.join(ortho_folder_path, "GainsLossDuplication/Gains_bybranch.tsv"), column_order=['Branch', 'Orthogroups_gained'])
    ListDictToTSV(exploded_lost_speciation, os.path.join(ortho_folder_path, "GainsLossDuplication/Loss_speciation_bybranch.tsv"), column_order=['Branch', 'Orthogroups_lost_speciation'])
    ListDictToTSV(exploded_duplicated, os.path.join(ortho_folder_path, "GainsLossDuplication/Duplications_bybranch.tsv"), column_order=['Branch', 'Orthogroups_duplicated'])
    ListDictToTSV(exploded_lost_postduplication, os.path.join(ortho_folder_path, "GainsLossDuplication/Loss_postduplication_bybranch.tsv"), column_order=['Branch', 'Orthogroups_lost_duplication'])
