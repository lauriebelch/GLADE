...
def main(ortho_folder_path):
    ...
    loss_s_file_path = os.path.join(ortho_folder_path, "GainsLossDuplication", "Loss_speciation_bybranch.tsv")
    Loss_s = []
    ...
    Dupes_file_path = os.path.join(ortho_folder_path, "GainsLossDuplication", "Duplications_bybranch.tsv")
    Dupes = []
    ...
    loss_pd_file_path = os.path.join(ortho_folder_path, "GainsLossDuplication", "Loss_postduplication_bybranch.tsv")
    Loss_pd = []
    ...
    Node_info_file_path = os.path.join(ortho_folder_path, "GainsLossDuplication", "node_parent_info.txt")
    Node_info = []
    ...
    Ortho_ancest_file_path = os.path.join(ortho_folder_path, "AncestralGenomes", "Ancestral_HOG_counts.csv")
    Ortho_ancest = []
    ...
    BS_file_path = os.path.join(ortho_folder_path, "GainsLossDuplication", "Branch_statistics.tsv")
    BS = []
    ...
    HOG_file_path = os.path.join(ortho_folder_path, "Orthogroups", "Orthogroups.tsv")
    HOG = []
    ...
    # save output
    ListDictToTSV(output, os.path.join(ortho_folder_path, "GainsLossDuplication/extant_OG_counts.tsv"))
    ...
    ListDictToTSV(data, os.path.join(ortho_folder_path, "GainsLossDuplication/OrthogroupBranchChange.tsv"))
